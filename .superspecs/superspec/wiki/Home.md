...
- 2026-09-25: [[ui/session-state-pattern]] — updated: `startSession` now draws at least half its words from the learner's relatively weakest words (weighted-session-selection)
